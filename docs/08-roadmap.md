...
- [ ] Scaffold Tauri v2 + React + TS + Vite; verify `tauri dev` and `tauri build` on Linux
- [ ] Repo layout per `07-tech-stack.md` §4; formatters, linters, pre-commit
...
- [ ] Command/history system with dirty-rect deltas + coalescing (`03-data-model.md` §6)
